...
export function LogoutButton() {
  return (
    <button 
      ...
      className="px-3 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-lg text-sm font-medium transition flex items-center shadow-sm border border-slate-200"
    >
