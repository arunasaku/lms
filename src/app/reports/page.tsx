  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Link href="/catalog/custom-report" className="bg-white p-6 rounded-xl shadow-sm border border-slate-200 hover:shadow-md hover:border-purple-300 transition group block">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h3 className="text-xl font-bold text-slate-800">Custom Catalog Report</h3>
          </div>
          <p className="text-slate-600 text-sm">Select specific catalog columns, filter by acquisition, category, item type, or date, and generate printable reports or CSV files.</p>
        </Link>

        <a href="/api/export/accession-register" download className="bg-white p-6 rounded-xl shadow-sm border border-slate-200 hover:shadow-md hover:border-emerald-300 transition group block">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h3 className="text-xl font-bold text-slate-800">Full Accession Register (CSV)</h3>
          </div>
          <p className="text-slate-600 text-sm">Export the complete accession register with all book records in UTF-8 CSV format suitable for Excel.</p>
        </a>
