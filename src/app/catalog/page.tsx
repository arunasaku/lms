    ...
    <div className="max-w-6xl mx-auto space-y-6">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-3">
          {canManageCatalog && (
            <>
              <Link href="/catalog/custom-report" className="bg-indigo-50 hover:bg-indigo-100 text-indigo-700 border border-indigo-200 px-4 py-2 rounded-lg text-sm font-medium transition shadow-sm flex items-center gap-1.5">
